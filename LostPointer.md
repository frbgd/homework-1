...
* ОР: одинаковые
2. ❌
* ФР: При наведении мыши на обложку альбома курсор становится pointer, но клик по обложке ни к чему не приводит
...
1. ❌При создании плейлиста по кнопке на главной странице неавторизованным пользователем перекидывает на страницу входа. После входа:
* ФР: открылась главная страница с обновленными альбомами
* ОР: началось воспроизведение выбранного альбома
